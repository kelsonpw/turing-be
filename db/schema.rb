...
ActiveRecord::Schema.define(version: 0) do
  ...
  create_table "attribute_value", primary_key: "attribute_value_id", id: :integer, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "attribute_id", null: false
    t.string "value", limit: 100, null: false
    t.index ["attribute_id"], name: "idx_attribute_value_attribute_id"
  end

  create_table "audit", primary_key: "audit_id", id: :integer, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "category", primary_key: "category_id", id: :integer, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "order_detail", primary_key: "item_id", id: :integer, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "order_id", null: false
  ...
  create_table "product", primary_key: "product_id", id: :integer, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name", limit: 100, null: false
  ...
  create_table "product_attribute", primary_key: ["product_id", "attribute_value_id"], options: "ENGINE=MyISAM DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "product_id", null: false
    t.integer "attribute_value_id", null: false
  end

  create_table "product_category", primary_key: ["product_id", "category_id"], options: "ENGINE=MyISAM DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "product_id", null: false
    t.integer "category_id", null: false
  end

  create_table "review", primary_key: "review_id", id: :integer, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "shipping", primary_key: "shipping_id", id: :integer, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "shipping_region", primary_key: "shipping_region_id", id: :integer, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8", force: :cascade do |t|
